...
export default function LoginPage() {
  ...
  useGSAP(() => {
    ...
    // Animate form elements (inputs AND button) together
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.detail || "Authentication failed. Please check your credentials.";
      alert(errorMessage);
      setLoading(false);
    }
  };
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="login-card bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* LOGIN BUTTON - Ensured it has 'form-element' class for animation visibility */}
            <button 
              type="submit" 
              disabled={loading}
